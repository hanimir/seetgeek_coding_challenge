...
def grade_php(path_to_manifest, path_to_input, verbose=False):
    executable = "php/normalize"
    grade(path_to_manifest, path_to_input, executable, verbose=verbose)
...
if __name__ == '__main__':
    ...
    assert args.lang in ('python', 'ruby', 'java', 'php')
    ...
    if args.lang == 'php':
        grade_php(args.manifest, args.input, args.verbose)
